...
export const userApiSlice =  apiSlice.injectEndpoints({ // userApiSlice represents an enhanced API slice that includes the getUsers endpoint.
    endpoints: builder =>({     
...
export const selectUserResults = userApiSlice.endpoints.getUsers.select()
...
export const {selectAll : selectAllUsers, selectById : selectUserById,selectIds : selectUserId} = userAdapter.getSelectors(state => selectUserData(state) ?? initialState)
